...
import { faCartShopping, faMobile, faUser } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    <div>
      ...
      >
        <div className="d-flex flex-wrap align-items-center justify-content-between">
          <div className="d-flex align-items-center">
            <Link to="/" className="d-inline-flex link-body-emphasis text-decoration-none text-white me-3">
          ...
          <div className="text-center d-flex align-items-center text-white margin-navbar">
            ...
            <div className="px-3 d-flex text-light align-items-center link-tag" style={{ boxShadow: 'none' }} size='lg'>
              ...
              <Link to='#login'><span className="cart-name"><Login /></span></Link>
            </div>
      ...
      <div className='linktag py-3'>
        <Link to="/medicine" className="px-2 text-white">Medicine</Link>
        <Link to="/healthblogs" className="px-2 text-white">Health Blogs</Link>
        <Link to="/plus" className="px-2 text-white">PLUS</Link>
        <Link to="/offers" className="px-2 text-white">Offers</Link>
        <Link to="/valuestore" className="px-2 text-white">Value Store</Link>
      </div>
    </div>
  );
}
